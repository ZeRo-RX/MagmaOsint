...
def start_Tor_search ():
	...
	'''+Fore.YELLOW + "python3 osint.py --save")

    InResults = input(Back.BLACK + Fore.MAGENTA + 'results  > ' + Back.RESET + Fore.WHITE)
    query = input(Back.BLACK + Fore.MAGENTA + 'Find > ' + Back.RESET + Fore.WHITE)
